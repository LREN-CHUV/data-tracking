"""import db schema from model

Revision ID: 9d012baee689
Revises: 6f49614bcd5a
Create Date: 2016-05-12 11:29:57.001363

"""

# revision identifiers, used by Alembic.
revision = '9d012baee689'
down_revision = '6f49614bcd5a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('gender', sa.Enum('male', 'female', 'other', 'unknown'), nullable=False),
    sa.Column('handedness', sa.Enum('left', 'right', 'ambidexter', 'unknown'), nullable=False),
    ...
    sa.Column('manufacturer_model_name', sa.String(length=45), nullable=False),
    sa.Column('institution_name', sa.String(length=45), nullable=False),
    ...
    sa.Column('scientist_id', sa.Integer(), nullable=False),
    sa.Column('scan_id', sa.Integer(), nullable=False),
    sa.Column('role', sa.Enum('technician', 'supervisor'), nullable=False),
    sa.ForeignKeyConstraint(['scan_id'], ['scan.id'], ),
    sa.ForeignKeyConstraint(['scientist_id'], ['researcher.id'], ),
    ...
    sa.PrimaryKeyConstraint('id', 'session_id', 'sequence_type_id')
    )
    ...
    sa.PrimaryKeyConstraint('id', 'sequence_id')
    )
    ...
    sa.PrimaryKeyConstraint('id', 'repetition_id')
    )
    ...
    sa.PrimaryKeyConstraint('id', 'quality_check_id', 'nifti_id')
    )
